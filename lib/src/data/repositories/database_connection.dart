...
class DatabaseConnection {
  ...
  _onCreatingDatabase(Database database, int version) async {
    ...
    await database.execute('CREATE TABLE "Users"(id character varying(255) NOT NULL,email character varying(255),"fullName" character varying(255),adress character varying(255),photo character varying(255),photoName character varying(255),CONSTRAINT "Users_pkey" PRIMARY KEY (id))');
  }
}
